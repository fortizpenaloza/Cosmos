...
There's several way to contribute to the project: reporting bugs, sending
feedback, proposing ideas for new features, fixing or adding documentation,
promoting the project, or even contributing code.

## Reporting issues

You can report issues [here](https://github.com/iot-uca/back-end/issues/new)
...
the `source` folder.
- The `release-candidate` branch contains the latest changes and should
